...
# Using `most_frequent` to fill in missing values and OHE
...
# 11. Define search space of classifiers and corresponding hyperparameters
...
# 12. Search over classifiers and hyperparameters above to optimize pipeline and fit
